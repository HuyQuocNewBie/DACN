  ...
  return (
    <div className="perspective-1000 group w-full max-w-2xl px-4">
      <div
        ...
        className={`preserve-3d relative min-h-104 w-full cursor-pointer rounded-[2.5rem] shadow-2xl transition-all duration-800 ${
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex min-h-0 w-full flex-1 flex-col items-center justify-center gap-4 py-4">
            {card.front_image_url && (
              <div className="max-h-56 min-h-0 w-full shrink overflow-hidden rounded-2xl border border-slate-100 shadow-sm">
                <img
            ...
            <h2
              className={`w-full shrink-0 text-2xl leading-tight font-black wrap-break-word text-slate-800 md:text-3xl ${
        ...
        >
          ...
          <div className="relative z-10 flex min-h-0 w-full flex-1 flex-col items-center justify-center gap-4 py-4">
            {card.back_image_url && (
              <div className="max-h-56 min-h-0 w-full shrink overflow-hidden rounded-2xl border border-white/10 shadow-lg">
                <img
            ...
            <p
              className={`w-full shrink-0 bg-linear-to-br from-white to-slate-400 bg-clip-text text-lg leading-relaxed font-medium wrap-break-word text-transparent md:text-xl ${
