...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      {authMode && (
        <div className="animate-in fade-in fixed inset-0 z-100 flex items-center justify-center bg-slate-900/40 p-6 backdrop-blur-xl duration-300 dark:bg-slate-950/80">
          ...
          <div className="animate-in zoom-in-95 relative w-full max-w-lg overflow-hidden rounded-[3.5rem] border border-white bg-white shadow-2xl duration-500 dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="p-10 md:p-14">
              ...
              <div className="mb-10 flex rounded-2xl bg-slate-100 p-1.5 dark:bg-slate-800/50">
                <button
                  onClick={() => setAuthMode('login')}
              ...
              <div className="relative flex items-center py-8">
                ...
                <span className="px-4 text-[10px] font-black tracking-widest text-slate-400 uppercase">
                  Hoặc đăng nhập qua
                </span>
                <div className="flex-1 border-t border-slate-200 dark:border-slate-800"></div>
              </div>
