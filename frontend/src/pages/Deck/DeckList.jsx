      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
        {currentPage === 1 && (
          <button
            ...
            className="group relative flex min-h-62.5 flex-col items-center justify-center overflow-hidden rounded-4xl border-2 border-dashed border-slate-200 p-10 transition-all duration-500 hover:border-indigo-500 hover:bg-indigo-50/30"
          >
            <div className="absolute inset-0 bg-linear-to-br from-indigo-50/50 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
            <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-3xl bg-slate-50 shadow-sm transition-all duration-500 group-hover:scale-110 group-hover:bg-indigo-500">
              <span className="text-4xl text-slate-400 transition-colors group-hover:text-white">
                +
              </span>
            </div>
            <span className="relative z-10 mt-6 text-xs font-black tracking-widest text-slate-400 uppercase group-hover:text-indigo-600">
              Tạo bộ thẻ mới
            </span>
          </button>
        )}
        ...
        {paginatedDecks.map((deck) => (
          <div
            key={deck.id}
            className="group relative flex h-full flex-col overflow-hidden rounded-4xl border border-slate-100 bg-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-500/10"
          >
            <div className="absolute top-0 right-0 -mt-16 -mr-16 h-32 w-32 rounded-full bg-slate-100 blur-2xl transition-colors duration-500 group-hover:bg-indigo-500/10"></div>

            <div className="relative z-10 flex-1">
              <div className="mb-6 flex items-start justify-between">
                <span
                  className={`rounded-xl border-2 px-3 py-1.5 text-[10px] font-black tracking-[0.15em] uppercase ${
                    deck.is_public
              ...
              <h3 className="mb-3 line-clamp-1 text-2xl leading-tight font-black text-slate-900 transition-colors group-hover:text-indigo-600">
                {deck.title}
              </h3>
            ...
            <div className="relative z-10 mt-8 flex items-center justify-between border-t border-slate-50 pt-6">
              <Link
                to={`/decks/${deck.id}`}
                className="flex items-center gap-2 text-xs font-black tracking-widest text-slate-900 uppercase transition-colors hover:text-indigo-600"
              >
                Chi tiết bộ thẻ
              ...
              <div className="h-2 w-2 rounded-full bg-slate-200 transition-colors group-hover:animate-ping group-hover:bg-indigo-500"></div>
            </div>
          </div>
        ))}
      </div>
            ...
            <div className="p-10 md:p-12">
              ...
              <form onSubmit={handleCreateDeck} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    autoFocus
                    className="w-full rounded-2xl border border-slate-100 bg-slate-50 px-6 py-4 font-bold text-slate-700 transition-all outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    rows="3"
                    className="w-full resize-none rounded-2xl border border-slate-100 bg-slate-50 px-6 py-4 font-medium text-slate-600 transition-all outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10"
                ...
                >
                  <div
                    className={`flex h-6 w-6 items-center justify-center rounded-lg border-2 transition-all ${newDeck.is_public ? 'border-emerald-500 bg-emerald-500' : 'border-slate-200 bg-white'}`}
                  >
                    {newDeck.is_public && (
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-700 transition-colors group-hover:text-emerald-700">
                      Công khai bộ thẻ
                    </p>
                    <p className="text-[10px] font-medium tracking-wider text-slate-400 uppercase transition-colors group-hover:text-emerald-500">
                ...
                <div className="flex gap-4 pt-6">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 rounded-2xl bg-slate-900 py-5 text-xs font-black tracking-[0.2em] text-white uppercase shadow-xl shadow-slate-200 transition-all hover:bg-indigo-600 hover:shadow-indigo-600/30 active:scale-95 disabled:opacity-50"
                  >
